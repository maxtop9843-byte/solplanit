...
export default function GuidesPage() {
  return <main className="guideShell">
    ...
    <aside className="guideCallout"><div><p className="guideEyebrow">내 조건으로 확인하기</p><h2>가이드를 읽었다면 실제 조건을 계산해보세요</h2><p>설치 면적과 건물 유형을 입력해 예상 용량을 확인하고, 필요하면 계산 결과를 전문가 분석으로 이어갈 수 있습니다.</p></div><div><Link className="guidePrimary" href="/#calculator">무료 계산 시작</Link><Link href="/trust/methodology">계산 방법 보기 →</Link></div></aside>
  </main>;
}
